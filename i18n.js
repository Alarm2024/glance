(function () {
  ...
  var STRINGS = {
    en: {
      ...
      installNote: 'Pre-1.0 stubs. Publish to crates.io / PyPI is a grant milestone.',
    ...
    ar: {
      ...
      installNote: 'إصدار ما قبل 1.0. النشر على crates.io و PyPI من أهداف المنحة.',
    ...
    ru: {
      ...
      installNote: 'До версии 1.0. Публикация на crates.io / PyPI — этап гранта.',
    ...
    zh: {
      ...
      sectionInstall: '安装',
      sectionLicense: '许可',
      installNote: '1.0 前版本。发布到 crates.io / PyPI 是资助里程碑。',
    ...
    de: {
      ...
      installNote: 'Pre-1.0. Veröffentlichung auf crates.io / PyPI ist ein Grant-Meilenstein.',
    ...
    es: {
      ...
      installNote: 'Pre-1.0. Publicar en crates.io / PyPI es un hito de la subvención.',
