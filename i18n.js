(function () {
  ...
  var STRINGS = {
    en: {
      ...
      bulletEyes: 'Glance eyes — fault-first health cards',
      bulletDry: 'Dry simulate — compose without sending',
      bulletClear: 'Operator CLEAR only — human gate, no auto-send',
      ...
      sectionAsk: 'Ask us',
      demoHint: 'Synthetic fixture below — client-side only, not live bot data.',
