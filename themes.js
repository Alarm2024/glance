(function(){
  var KEY='house-theme';
  var THEMES={
    midnight:{bg:'#0c0c10',ink:'#e8e4dc',dim:'#9a958a',accent:'#c9a962',card:'#14141c',line:'rgba(201,169,98,.35)',dot:'#2ee6c7'},
  ...
  function apply(name){
    ...
    r.style.setProperty('--ink',t.bg);
    r.style.setProperty('--text',t.ink);
    r.style.setProperty('--text-muted',t.dim);
    r.style.setProperty('--gold',t.accent);
    r.style.setProperty('--gold-warm',t.accent);
    r.style.setProperty('--gold-dim',t.line);
    r.style.setProperty('--ink-soft',t.card);
    r.style.setProperty('--ink-muted',t.card);
